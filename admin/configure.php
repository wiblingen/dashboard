...
<h1>ODS <?php echo __( 'Dashboard' ) . " - ".__( 'Configuration' );?></h1>
        <div class="navbar">
			...
			<a class="menuupdatedashboard" href="/update-dashboard/update-dashboard.php">'.__( 'Update-dashboard' ).'</a>';
			<a class="noMob menuupdate" href="/admin/advanced/services.php?action=updatehostsfiles"><?php echo __( 'ODS Update' );?></a>
            <a class="noMob menuupdate" href="/admin/advanced/services.php?action=updatehostsfiles"><?php echo __( 'hovno' );?></a>
